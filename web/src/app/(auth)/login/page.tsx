...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-svh flex flex-col items-center justify-center bg-gradient-to-br from-green-50 to-emerald-100 dark:from-background dark:to-muted p-4">
